        ...
        <div class="row py-2">
            ...
            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading">معالجة لثوية</h3>
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row d-flex align-items-center">
            <div class="col-md-3 aside-stretch py-5">
                <div class=" heading-section heading-section-white ftco-animate pr-md-4">
                    ...
                    <p>احصائيات المرضى خلال الاعوام الماضية الذين تم العمل عليهم</p>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="staff">
                    ...
                    <div class="info text-center">
                        ...
                        <div class="text">
                            ...
                            <p>ماجستير في جراحة الوجه والفكين</p>
            ...
            <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    ...
                    <div class="info text-center">
                        <span class="position">الطبيب</span>
                        <h3><a href="teacher-single.html">محمد خطاب</a></h3>
                        <div class="text">
            ...
            <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    ...
                    <div class="info text-center">
                        ...
                        <h3><a href="teacher-single.html">حلا العثمان</a></h3>
                        <div class="text">
